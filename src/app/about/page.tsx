    ...
    <div className="flex flex-col items-center justify-start min-h-screen bg-gray-50 py-12 px-4 lg:py-24">
      ...
      <div className="max-w-3xl w-full bg-white p-8 shadow-lg rounded-lg">
        ...
        <p className="text-lg text-center text-gray-700 leading-relaxed">
          ...
          landscaping project or simply looking to maintain your garden, we have
          everything you need. Our knowledgeable staff is here to assist you
          with expert advice and top-notch customer service. Visit us today and
          discover why Route 9 Landscape Products is the trusted choice for
          landscaping supplies in the Northeast.
        </p>
      </div>
    </div>
  );
